...
public class EditorialController {
	...
	public String insertar(String name, String telefono, String email,
						   Model model) {
		logger.info("[EditorialController-insertar] name:"+ name+" telefono:"+ telefono+" email:"+email);
		
		Editorial editorial = new Editorial(name, telefono, email);
